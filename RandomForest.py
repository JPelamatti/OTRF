...
class RandomForestRegressionAlgorithm(object):
    """
    ...
    def predict(self, predictInput):
        ...
        for tree in self.treeList:
            predictOutput += tree.computePrediction(predictInput)
        return predictOutput/self.treeNumber
...
forest = RandomForestRegressionAlgorithm(inputSample, outputSample)
